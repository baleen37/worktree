...
Install the published `worktree-cli` v0.1.2 from crates.io:

```sh
cargo install worktree-cli --version 0.1.2 --locked
```

### macOS and Linux

Install the pinned `v0.1.2` release with the cargo-dist shell installer:
